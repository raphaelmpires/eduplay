...
const Translation = {
  ...
  t(en, pt) {
    ...
    return `<span class="ep-translate-wrap" onclick="this.classList.toggle('show-tooltip'); event.stopPropagation();"><span class="ep-translate">${en}</span><span class="ep-translate-tooltip">🇧🇷 ${safePt}</span></span>`;
  }
};
